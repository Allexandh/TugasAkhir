...
public class NusaTenggaraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_nusatenggara,container,false);
        setUpRecycleView();
        return view;
    }

    private void setUpRecycleView(){
        Query query = destinationref.whereEqualTo("subgrup","Nusa Tenggara").orderBy("nama",Query.Direction.DESCENDING);
