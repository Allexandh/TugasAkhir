...
public class KalimantanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_kalimantan,container,false);
        setUpRecycleView();
        return view;
    }

    private void setUpRecycleView(){
        Query query = destinationref.whereEqualTo("subgrup","Kalimantan").orderBy("nama",Query.Direction.DESCENDING);
