...
public class SumatraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sumatra,container,false);
        setUpRecycleView();
        return view;
    }

    private void setUpRecycleView(){
        Query query = destinationref.whereEqualTo("subgrup","Sumatra").orderBy("nama",Query.Direction.DESCENDING);
