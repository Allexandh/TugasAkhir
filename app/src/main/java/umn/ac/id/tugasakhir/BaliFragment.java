...
public class BaliFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_bali,container,false);
    ...
    private void setUpRecycleView(){
        Query query = destinationref.whereEqualTo("subgrup","Bali").orderBy("nama",Query.Direction.DESCENDING);
